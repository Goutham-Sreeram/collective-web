    ...
    <>
      ...
      <div style={{ 
        ...
        <main className="min-h-screen bg-gray-100 relative flex items-center justify-center">
          {/* Background Pattern */}
          <DotPattern className={cn("mask-[radial-gradient(700px_circle_at_center,white,transparent)]")} />
          ...
          </div>) : (<div className="relative z-10 text-center max-w-4xl mx-auto px-6">
            {/* Main Heading */}
            <h1
